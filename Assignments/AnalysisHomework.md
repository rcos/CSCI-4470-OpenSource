...
One this initial analysis is complete, pick the project that appeals to you the most and do a more in depth analysis. Expand on your 1 sentence supporting data, discuss what the goal of the project is, discuss why it appeals to you and discuss the significane of the project. There is no firm length for this part, but I anticipate that a good report may be in the range of 3-5 pages.
