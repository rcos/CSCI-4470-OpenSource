/* $Id: VBoxMPVdma.h 73097 2018-07-12 21:06:33Z vboxsync $ */
/** @file
...
#define VBOXVDMAPIPE_CMD_HDR_FROM_ENTRY(_pE)  ( (PVBOXVDMAPIPE_CMD_HDR)((uint8_t *)(_pE) - RT_UOFFSETOF(VBOXVDMAPIPE_CMD_HDR, ListEntry)) )
