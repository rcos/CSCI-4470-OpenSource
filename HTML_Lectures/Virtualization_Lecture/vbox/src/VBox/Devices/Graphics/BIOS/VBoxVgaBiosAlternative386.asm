; $Id: VBoxVgaBiosAlternative386.asm 69807 2017-11-22 13:55:09Z vboxsync $ 
;; @file
...
biosfn_set_video_mode_:                      ; 0xc0fdc LB 0x3aa
    ...
    movzx ax, byte [si+046beh]                ; 0f b6 84 be 46
    cmp bx, ax                                ; 39 c3
    ...
    mov al, byte [si+046cbh]                  ; 8a 84 cb 46
    mov dx, 003c2h                            ; ba c2 03
    out DX, AL                                ; ee
    mov AL, strict byte 020h                  ; b0 20
    mov dx, 003c0h                            ; ba c0 03
    ...
    movzx bx, byte [si+07c5dh]                ; 0f b6 9c 5d 7c
