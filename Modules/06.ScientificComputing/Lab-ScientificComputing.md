...
- Run the example from [https://github.com/networkx/networkx/blob/main/examples/drawing/plot_multipartite_graph.py](https://github.com/networkx/networkx/blob/main/examples/drawing/plot_multipartite_graph.py). If the script outputs a multipartite graph of different colors, the installation is working correctly.
